                ...
                <div className="flex items-center justify-center md:justify-start gap-2">
                  <div
                    className={`w-3 h-3 rounded-full ${
                      formData.available ? "bg-green-400" : "bg-red-400"
                    }`}
                  ></div>
            ...
            <div className="mb-4">
              ...
              {isEdit ? (
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  <p className="text-gray-700">{doctorProfileData.address?.line1}</p>
                  <p className="text-gray-700">{doctorProfileData.address?.line2}</p>
                </div>
              )}
            </div>
